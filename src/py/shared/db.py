...
INSERT_SQL = "REPLACE INTO {} ({}) VALUES ({})"

LOAD_DATA_INFILE_SQL = "LOAD DATA INFILE '{}' REPLACE INTO TABLE {} FIELDS OPTIONALLY ENCLOSED BY '\"' TERMINATED BY ',' LINES TERMINATED BY '\\r\\n'"
